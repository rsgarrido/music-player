...
internal const val COVER_FLOW_METADATA_ROTATION_MULTIPLIER = 0.60f
internal const val COVER_FLOW_CAMERA_DISTANCE_MULTIPLIER = 14f
internal const val COVER_FLOW_METADATA_CAMERA_DISTANCE_MULTIPLIER = 11f
...
private const val DEPTH_METADATA_SCALE_REDUCTION = 0.12f
private const val DEPTH_METADATA_ALPHA_REDUCTION = 0.24f

private const val COVER_FLOW_SCALE_REDUCTION = 0.06f
private const val COVER_FLOW_ALPHA_REDUCTION = 0.15f
private const val COVER_FLOW_METADATA_SCALE_REDUCTION = 0.05f
