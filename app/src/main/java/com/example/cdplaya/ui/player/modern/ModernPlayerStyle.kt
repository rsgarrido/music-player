...
data class ModernPlayerStyle(
    ...
    val controlsSurfaceTopColor: Color,
    val controlsSurfaceBottomColor: Color,
    val controlsSurfaceBorderColor: Color,
...
object ModernPlayerDefaults {
    ...
    fun style(): ModernPlayerStyle {
        return ModernPlayerStyle(
            ...
            controlsSurfaceTopColor = Color.White.copy(alpha = 0.13f),
            controlsSurfaceBottomColor = Color.Black.copy(alpha = 0.28f),
            controlsSurfaceBorderColor = Color.White.copy(alpha = 0.18f),
